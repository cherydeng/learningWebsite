<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="exp_comment.aspx.cs" Inherits="EXP_F.exp_comment" %>

<!DOCTYPE html>
<html class="no-js" lang="en-US">
<link href="Content/comment_css.css" rel="stylesheet" />
<head>
    <meta charset="utf-8">
...
<body>
            ...
            <div class="row">
                <div class="col-md-10">
                    <nav class="navbar navbar-expand-md">
                        <a class="navbar-brand" href="index.html"><img src="images/ddcx_logo.jpg" alt="Logo"></a>
                        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#main-menu" aria-controls="main-menu" aria-expanded="false" aria-label="Toggle navigation">
                            <span class="navbar-toggler-icon"><i class="fas fa-bars"></i></span>
                        </button>
                        <div class="collapse navbar-collapse" id="main-menu">
                            <ul class="navbar-nav">
                                <li class="nav-item menu-item-has-children dropdown"><a class="dropdown-item" href="exp_index.html">主页</a></li>
                                <li class="nav-item menu-item-has-children dropdown active"><a class="dropdown-item" href="exp_comment.html">评论</a></li>
                                <li class="nav-item menu-item-has-children dropdown"><a class="dropdown-item" href="exp_contact.html">关于</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
    ...
    <div class="comments">
        ...
        <div class="comment-wrap">
            <div class="photo">
                <div class="avatar" style="background-image: url('/assets/coolgirl.jpg')"></div>
            </div>
            <div class="comment-block">
                <p class="comment-text">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto temporibus iste nostrum dolorem natus recusandae incidunt voluptatum. Eligendi voluptatum ducimus architecto tempore, quaerat explicabo veniam fuga corporis totam reprehenderit
                    quasi sapiente modi tempora at perspiciatis mollitia, dolores voluptate. Cumque, corrupti?
                </p>
        ...
        <div class="comment-wrap">
            <div class="photo">
                <div class="avatar" style="background-image: url('images/avatar/1.jpg')"></div>
            </div>
            <div class="comment-block">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="member">
                            ...
                            <div class="member-details">
                                <h4 class="name"><a href="#">Raymond Herrera</a></h4><!-- /.name -->
                    ...
                    <div class="col-md-3">
                        <div class="member">
                            ...
                            <div class="member-details">
                                <h4 class="name"><a href="#">Aaron Palmer</a></h4><!-- /.name -->
                    ...
                    <div class="col-md-3">
                        <div class="member">
                            ...
                            <div class="member-details">
                                <h4 class="name"><a href="#">John Walsh</a></h4><!-- /.name -->
                    ...
                    <div class="col-md-3">
                        <div class="member">
                            ...
                            <div class="member-details">
                                <h4 class="name"><a href="#">Joshua Kim</a></h4><!-- /.name -->
                                <span class="designation">Mentor</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="member">
                            ...
                            <div class="member-details">
                                <h4 class="name"><a href="#">John Parker</a></h4><!-- /.name -->
                    ...
                    <div class="col-md-3">
                        <div class="member">
                            ...
                            <div class="member-details">
                                <h4 class="name"><a href="#">Jerry Harper</a></h4><!-- /.name -->
                                <span class="designation">Mentor</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="member">
                            ...
                            <div class="member-details">
                                <h4 class="name"><a href="#">Benjamin Ortiz</a></h4><!-- /.name -->
                                <span class="designation">Designer</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="member">
                            ...
                            <div class="member-details">
                                <h4 class="name"><a href="#">Ryan Jensen</a></h4><!-- /.name -->
                                <span class="designation">Developer</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="copy-right float-left">
                                <span>Copyright &copy; 2018.Company name All rights reserved.<a target="_blank" href="http://sc.chinaz.com/moban/">&#x7F51;&#x9875;&#x6A21;&#x677F;</a></span>
                            </div><!-- /.copy-right -->
                        </div>
                        <div class="col-md-4">
