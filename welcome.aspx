...
<body ondragstart="window.event.returnValue=false" oncontextmenu="window.event.returnValue=false" onselectstart="event.returnValue=false" runat="server">
    ...
    <div id="hovertreecontainer">
        ...
        <div>
            <h1 id="h1">欢迎您</h1>
            <h2 id="h2"> 进入东南大学成贤学院在线学习平台！</h2>
            <p>&nbsp;</p>
            <p>&nbsp;</p>


            <p><strong><a href='<%=Text() %>'>进入主站</a></strong></p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <strong><asp:Label ID="Label1" runat="server" style="width: 220px;height: 46px; align:center;outline: none;font:14px;font-size:xx-large"></asp:Label></strong>
        </div>
    ...
    <audio autoplay="autoplay">
        <source src="music/八三夭乐团-想见你想见你想见你.mp3" type="audio/ogg">
    ...
    </audio><script type="text/javascript" src="//hovertree.com/texiao/html5/index/hovertreewelcome.js">
    </script>
